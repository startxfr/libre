...
- [Docker user guide](https://github.com/startxfr/libre/tree/v0.5.39/docs/guides/USE_docker.md)
- [NodJS user guide](https://github.com/startxfr/libre/tree/v0.5.39/docs/guides/USE_npm.md)
- [Source code user guide](https://github.com/startxfr/libre/tree/v0.5.39/docs/guides/USE_source.md)

## Documentation

If you want to have more information on how to install, develop and run this framework and use it in your project, please read the [full documentation](https://github.com/startxfr/libre/tree/v0.5.39/docs/README.md) or our [user guides](https://github.com/startxfr/libre/tree/v0.5.39/docs/guides/README.md) and execute the following steps :
1. [Install libre](https://github.com/startxfr/libre/tree/v0.5.39/docs/guides/1.Install.md)
2. [Configure libre](https://github.com/startxfr/libre/tree/v0.5.39/docs/guides/2.Configure.md)
3. [Run your job](https://github.com/startxfr/libre/tree/v0.5.39/docs/guides/3.Run.md)
...
This project is mainly developped by the [startx](https://www.startx.fr) dev team. You can see the complete list of contributors who participated in this project by reading [CONTRIBUTORS.md](https://github.com/startxfr/libre/tree/v0.5.39/docs/CONTRIBUTORS.md).

## License

This project is licensed under the GPL Version 3 - see the [LICENSE.md](https://github.com/startxfr/libre/tree/0.5.39/docs/LICENSE.md) file for details
